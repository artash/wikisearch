...
/**
 * This file is ripped from org.apache.lucene.benchmark.byTask.feeds package and amended to
 * add latest revision contributor parsing from the source xml. [artash]
 */
...
public class EnwikiContentSource extends ContentSource {
    ...
    private static final int TITLE = USERNAME + 1;
    private static final int BODY = TITLE + 1;
    ...
    static {
        ...
        ELEMENTS.put("username", Integer.valueOf(USERNAME));
    }
    ...
    public synchronized DocData getNextDocData(DocData docData) throws NoMoreDataException, IOException {
        ...
        docData.setUsername(tuple[USERNAME]);
        return docData;
    }
